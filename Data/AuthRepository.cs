    ...
    public class AuthRepository : IAuthRepository
    {
        ...
        public UsuarioDTO GetUserFromCredentials(UsuarioRegisterPostDTO loginDtoIn) {
            ...
            if ( usuario == null)
            {
                ...
                var user = new UsuarioDTO { IdUsuario = usuario.IdUsuario, NombreUsuario = usuario.NombreUsuario, Nombre = usuario.Nombre, Contrasena = usuario.Contrasena, IdCiudadano = usuario.IdCiudadano, IsPolicia = usuario.IsPolicia};
                return user;
        }
    }
}
